...
class Hazel {
    ...
    constructor(config, StorageProvider) {
        ...
        this._compendiaController   = new CompendiaController(this._server, this._config, authMethod, this._documentRepository, this._searchProvider, this._analyticsService, this._storageProvider);
